...
The `prspnsd.invariants` module provides assertion helpers that encode the
...
```python
from prspnsd.invariants import assert_hopbound
...
```python
from prspnsd.invariants import assert_partition_correctness
...
```python
from prspnsd.invariants import assert_distance_approximation
...
```python
from prspnsd.invariants import check_equivalence_classes
