...
This note explains the test fixtures added in `prspnsd/generators.py`
...
## What's in `prspnsd/generators.py`
...
`prspnsd/spectrum.py` provides `spectrum(g)` and `spectral_gap(g)`
